...
public class RippleLayout extends LinearLayout implements Runnable {
    ...
    private int mSecondRevealRadius = 0;
    private int mThirdRevealRadius = 0;
    ...
    private void initParametersForChild(MotionEvent event, View view) {
        ...
        mRevealRadius = 0;
        mSecondRevealRadius = 0;
        mThirdRevealRadius = 0;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mRevealRadius > mMinBetweenWidthAndHeight / 2) {
            ...
            mSecondRevealRadius += mRevealRadiusGap * 9;
            mThirdRevealRadius += mRevealRadiusGap*10;
        } else {
            mRevealRadius += mRevealRadiusGap;
            mSecondRevealRadius += mRevealRadiusGap;
            mThirdRevealRadius += mRevealRadiusGap;
        }
        this.getLocationOnScreen(mLocationInScreen);
        int[] location = new int[2];
        ...
        canvas.drawCircle(mCenterX, mCenterY, mSecondRevealRadius, mPaint);
        canvas.restore();
